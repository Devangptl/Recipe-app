...
const Navbar = () => {
  ...
  return (
    <header className='w-full fixed z-10 bg-black opacity-90 ' >
      <nav className='flex w-full py-2 md:py-3 px-4 md:px20 items-center justify-between'>
            ...
            <a href="/" className='flex items-center justify-center text-white text-lg cursor-pointer' >
                ...
                <p className='font-bold' >Flavor<span className='text-green-500 text-xl' >Verse</span></p>
            </a>
